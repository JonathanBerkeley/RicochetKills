class OptionScene extends Phaser.Scene {
  ...
  create() {
      ...
      this.add.image(this.scaleW / 2, 200, 'options');
      //create draw previous shot line
      this.startDrawButton = new SettingButton(this, this.scaleW / 2, this.scaleH * 0.45, 'button1', 'button2', 'AIM ASSIST', this.startScene.bind(this, 'Title'), 2);
      //create mute button
